function CButMode(iXPos,iYPos,oSpriteMode,szText,szFont,szColor,iFontSize,oParentContainer){
    var _bDisable;
    var _iCurScale;
    var _iWidth;
    var _iHeight;
    ...
    this._init = function(iXPos,iYPos,oSpriteMode,szText,szFont,szColor,iFontSize){
        _bDisable = false;
        _iCurScale = 1;
	...
	if (!s_bMobile){
        ...
        var oMode = createBitmap(oSpriteMode);
        oMode.regX = oSpriteMode.width/2;
        oMode.regY = oSpriteMode.height/2;
        oMode.x = oSprite.width/2;
        oMode.y = oSprite.height/2+30;
        _oButton.addChild(oMode);
    ...
    this._init(iXPos,iYPos,oSpriteMode,szText,szFont,szColor,iFontSize);
}