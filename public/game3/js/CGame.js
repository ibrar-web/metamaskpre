function CGame(oData) {
    ...
    this.setMoney = function (iMoney) {
        ...
        _oInterface.refreshCredit(iMoney, userbet,'1');
        ...
        if (_bPlayerTurn) {
            ...
            if (_bNaturalBj) {
                ...
                if (_iInsuranceBet > 0 && _aDealerCards.length === 2) {
                    _oSeat.increaseCredit((_iInsuranceBet * 2) + _iInsuranceBet, '1');
                    _iGameCash -= (_iInsuranceBet * 2);

                    _oInterface.refreshCredit(_oSeat.getCredit(), userbet,'2');
    ...
    this._playerWin = function (iHand) {
        ...
        _oSeat.increaseCredit(iTotalWin, '2');
    ...
    this.playerStandOff = function (iHand) {
        _oSeat.increaseCredit(_oSeat.getBetForHand(iHand), '3');
      
        _iGameCash -= _oSeat.getBetForHand(iHand);
        userwin = _oSeat.getBetForHand(iHand);
    ...
    this.ficheSelected = function (iFicheValue, iFicheIndex) {
        ...
        if (iFicheValue > _oSeat.getCredit()) {
            ...
            _oInterface.refreshCredit(_oSeat.getCredit(), userbet,'3');
        }
    };
    ...
    this.onDeal = function () {
        if (_oSeat.getCredit() + _oSeat.getCurBet() < s_oGameSettings.getFichesValueAt(0)) {
            this._gameOver();
    ...
    this.onDouble = function () {
        ...
        _oSeat.bet(iCurBet);
        _oInterface.refreshCredit(_oSeat.getCredit(),userbet, '4');
        this.onHit();
    ...
    this._onSplitCardEndAnim = function () {
        ...
        _oInterface.refreshCredit(_oSeat.getCredit(),userbet, '5');
    ...
    this.clearBets = function () {
        ...
        if (iCurBet > 0) {
            ...
            _iGameCash -= iCurBet;
            _oInterface.refreshCredit(_oSeat.getCredit(),userbet, '6');
        }
    };
    ...
    this.rebet = function () {
        ...
        if (iValue > 0) {
            ...
            _oInterface.refreshCredit(_oSeat.getCredit(),userbet, '7');
    ...
    this.onBuyInsurance = function () {
        ...
        _oInterface.refreshCredit(_oSeat.getCredit(), userbet,'8');
    ...
    this._updateShowWinner = function () {
        ...
        if (_iTimeElaps > TIME_END_HAND) {
            ...
            userbet=_oSeat.userbet();
            userwin=_oSeat.userwin();
            _oSeat.clearuserbet()
            _oInterface.refreshCredit(_oSeat.getCredit()+userwin,userbet,'9');
            userbet=0;
            userwin=0;
        }
    };
