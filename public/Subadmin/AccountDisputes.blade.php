    ...
    <div class="content">
        ...
        <div class="data-table">
            <div style="width:100%;display: flex; flex-direction: row">
                ...
                <div style="display:felx;flex-direction:row-reverse;width:50%;">
            ...
            <div class="tablenew">
                ...
                <div class="tablebody" ng-repeat="(key,item) in pagedItems[currentPage] | filter:test">
                    <div class="tablebody1">
                        ...
                        <div class="name"><%item.Bounceback%></div>
                    ...
                    <div class="tableaction" ng-if="!item.id">
                        <div class="credit"><span><%item.Redeems%></span></div>
                        <div class="name"><%item.Boucreditnceback%></div>
