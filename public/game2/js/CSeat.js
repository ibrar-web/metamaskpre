function CSeat(){ 
    ...
    this.setCredit = function(iNewCredit){
        ...
        _iCredit = iNewCredit;
       // console.log('iNewCredit',iNewCredit,_iCredit);
    };
