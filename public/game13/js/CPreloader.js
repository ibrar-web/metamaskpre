function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./game13/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./game13/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./game13/sprites/but_start.png");
