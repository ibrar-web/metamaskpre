function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./game4/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./game4/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./game4/sprites/but_start.png");
