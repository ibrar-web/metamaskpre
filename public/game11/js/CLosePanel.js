function CLosePanel(oSpriteBg) {
    ...
    this._init = function (oSpriteBg) {
        ...
        _oButMenu = new CGfxButton(0, 200, oSpriteButHome, _oPanelContainer);
        _oButMenu.addEventListener(ON_MOUSE_DOWN, _oParent._onExit, this);

        var oSprite = s_oSpriteLibrary.getSprite('but_long');
        _oButRedeem = new CToggle(0, 200, oSprite, true, _oPanelContainer); 
    ...
    this.show = function (aInfo, aExtractionNum, oPrizeInfo) {
        ...
        if(oPrizeInfo.redeem_link !== ""){
            _oButRedeem.setVisible(true);
            _oButMenu.setVisible(false);
        }else {
            _oButRedeem.setVisible(false);
            _oButMenu.setVisible(true);
        }
