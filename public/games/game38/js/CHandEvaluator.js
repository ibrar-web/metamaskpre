function CHandEvaluator(){
    ...
    this.evaluate = function(aHand,bDealer){
        ...
        return {ret:this.rankHand(bDealer),sort_hand:_aOrigSortedHand};
    };
    
    this.rankHand = function(bDealer){
        if(this._checkForRoyalFlush()){
            ...
            return ONE_PAIR;
        }else if(this._checkHighCard(bDealer)){
            return HIGH_CARD;
        }else{
            return NO_HAND;
        }
    ...
    this._checkHighCard = function(bDealer){
        var bAceFound = false;
