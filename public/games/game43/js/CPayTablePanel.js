function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        _oListenerBlock = _oContainer.on("click",function(){});
        ...
        var iYPos = 265;
        for(var j=0;j<3;j++){
            var oText = new createjs.Text("X"+(j+3)+" -> "+NUM_FREESPIN[j]+ " "+TEXT_FREESPINS,"24px "+FONT_GAME_1, "#ffff00");
        ...
        var oText = new createjs.Text(TEXT_HELP_FREESPIN,"36px "+FONT_GAME_1, "#fff");
        oText.textAlign = "center";
        ...
        //ATTACH ARROW
        _oButArrowNext = new CGfxButton(CANVAS_WIDTH/2 + 540,CANVAS_HEIGHT/2,s_oSpriteLibrary.getSprite('but_arrow_next'),_oContainer);
        _oButArrowNext.addEventListener(ON_MOUSE_UP, this._onNext, this);
        
        _oButArrowPrev = new CGfxButton(CANVAS_WIDTH/2 - 540,CANVAS_HEIGHT/2,s_oSpriteLibrary.getSprite('but_arrow_prev'),_oContainer);
        _oButArrowPrev.addEventListener(ON_MOUSE_UP, this._onPrev, this);
        
        
        
        var oSprite = s_oSpriteLibrary.getSprite('but_exit');
        _oButExit = new CGfxButton(1250, 120, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this._onExit, this);
    };
    
    this.unload = function(){
        _oContainer.off("click",_oListenerBlock);
    ...
    this._createPayouts = function(oContainerPage){
        ...
        var aPos = [{x:980,y:448},{x:760,y:448},{x:540,y:448},{x:1090,y:338},{x:870,y:338},{x:650,y:338},{x:430,y:338}];
        var iCurPos = 0;
        for(var i=0;i<PAYTABLE_VALUES.length;i++){
            ...
            for(var j=0;j<iLen;j++){
                var oTextMult = new createjs.Text("X"+(5-j),"20px "+FONT_GAME_1, "#ffffff");
                ...
                var oText = new createjs.Text(aSymbolPayouts[iLen-j-1],"20px "+FONT_GAME_1, "#ffff00");
                oText.textAlign = "center";
                oText.x = oTextMult.x + 35;
                oText.y = oTextMult.y;
                oText.textBaseline = "alphabetic";
                oContainerPage.addChild(oText);
