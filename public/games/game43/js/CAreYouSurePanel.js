function CAreYouSurePanel() {
    ...
    this._init = function () {
        ...
        _oButYes = new CGfxButton(CANVAS_WIDTH / 2 + 120, CANVAS_HEIGHT * 0.5 + 70, s_oSpriteLibrary.getSprite('but_yes'), _oContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(CANVAS_WIDTH / 2 - 120, CANVAS_HEIGHT * 0.5 + 70, s_oSpriteLibrary.getSprite('but_exit'), _oContainer);
