function CHandEvaluator(){
	...
	this._checkForFiveAces = function(){
        if ( _aSortedHand[4]["rank"] == CARD_JOKER &&
                        _aSortedHand[0]["rank"] == _aSortedHand[1]["rank"] &&
                        _aSortedHand[2]["rank"] == _aSortedHand[3]["rank"] &&
                        _aSortedHand[0]["rank"] == _aSortedHand[2]["rank"] &&
                        _aSortedHand[0]["rank"] == CARD_ACE ){
            return true;
        }else{
            return false;
        }
