function CPreloader() {
    ...
    this._init = function() {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./games/game25/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./games/game25/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./games/game25/sprites/but_start.png");
    ...
    this.attachSprites = function() {
        ...
        _oLoadingText = new createjs.Text("", "40px " + FONT_GAME_1, "#fff");
