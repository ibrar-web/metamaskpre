function CStaticSymbolCell(iRow,iCol,iXPos,iYPos){
    ...
    this._init = function(iRow,iCol,iXPos,iYPos){
        ...
        _oAmountText = new CTLText(_oImageAttach, 
                    SYMBOL_ANIM_WIDTH/2-oSpriteAmount.width/2, SYMBOL_ANIM_HEIGHT - 22, oSpriteAmount.width, 48, 
                    48, "center", "#ffd102", FONT_GAME_1, 1,
                    0, 0,
                    " ",
                    true, true, false,
                    false);
        _oAmountText.setShadow("#000",2,2,2);
    ...
    this.show = function(iValue,iAmountWin,oPos,oRegPoint,iAnimCycle){
        ...
        _oAmountBg.visible = false;
        if(iAmountWin > 0){
            _oAmountText.refreshText("x"+iAmountWin);
