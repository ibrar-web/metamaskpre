function CGameOver(){
    ...
    this._init = function(){
        ...
        _oButRecharge = new CTextButton(CANVAS_WIDTH/2 -100,450,s_oSpriteLibrary.getSprite('but_game_bg'),TEXT_RECHARGE,FONT_GAME_1,"#fff",16,_oContainer);
        _oButRecharge.addEventListener(ON_MOUSE_UP, this._onRecharge, this);
        
        _oButExit = new CTextButton(CANVAS_WIDTH/2 + 100,450,s_oSpriteLibrary.getSprite('but_game_bg'),TEXT_EXIT,FONT_GAME_1,"#fff",20,_oContainer);
